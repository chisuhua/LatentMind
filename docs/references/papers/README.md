...
**总计**：3 完整 PDF + 4 HTML（含 1 abs 摘要页）
...
- 实测下载速度：~50 KB/s（**正常**）
- **例外**：2026-05 发布的 HRM-Text 太新，ar5iv 尚未完整处理 → 退化为 arXiv abs 摘要页（https://arxiv.org/abs/2605.20613）
...
4. **使用已有的 hrm-text.md 笔记**：本目录外的 [`../hrm-text.md`](../hrm-text.md) 包含几乎所有关键内容，足以代替原 PDF
